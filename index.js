...
const serverHost = process.env.SERVER_HOST || 'NatureSMP-qnoD.aternos.me';
const serverPort = parseInt(process.env.SERVER_PORT || '24668', 10);
const botUsername = process.env.BOT_USERNAME || 'Binu';
